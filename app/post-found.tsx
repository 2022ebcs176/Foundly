...
export default function PostFoundScreen() {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      // Create the found item post with exact API field names and formats
      const itemData = {
      ...
      if (response.success && response.data?.id) {
        await saveItemPostType(response.data.id, "found");
      }
          ...
          >
            ...
            <View style={styles.section}>
              <Pressable onPress={() => setShowTimePicker(true)}>
                <RoundedInput
                  ...
                  value={time}
                  placeholder="What time did you find it?"
                  icon={
                    <Ionicons
                      name="time-outline"
                      size={22}
            ...
            <View style={styles.section}>
              <RoundedInput
                ...
                placeholder="Where did you find it? (e.g., Library, Cafe)"
              />
            </View>
